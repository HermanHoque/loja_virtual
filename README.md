...
3- digite composer install (para instalar as dependencias do projeto)

4- digite copy .env.example .env (para criar o arquivo .env)

5- digite php artisan key:generate

6 - cria uma base de dados manualmente com o nome "loja" e depois digite 
no terminar raiz do projeto o comando php artisan migrate (para criar as tabelas automaticamente)
